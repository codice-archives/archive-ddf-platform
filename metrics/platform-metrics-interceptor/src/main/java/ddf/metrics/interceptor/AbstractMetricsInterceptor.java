...
public abstract class AbstractMetricsInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    static final Histogram messageLatency = metrics.register(MetricRegistry.name(HISTOGRAM_NAME), new Histogram(new SlidingTimeWindowReservoir(1, TimeUnit.MINUTES)));
